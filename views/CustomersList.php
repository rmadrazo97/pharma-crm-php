...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fcustomerslist = new ew.Form("fcustomerslist", "list");
    currentPageID = ew.PAGE_ID = "list";
    currentForm = fcustomerslist;
...
<form name="fcustomerslist" id="fcustomerslist" class="ew-form ew-list-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<table id="tbl_customerslist" class="table table-bordered table-hover table-sm ew-table"><!-- .ew-table -->
<thead>
...
<?php if ($Page->state->Visible) { // state ?>
        <th data-name="state" class="<?= $Page->state->headerCellClass() ?>"><div id="elh_customers_state" class="customers_state"><?= $Page->renderFieldHeader($Page->state) ?></div></th>
<?php } ?>
<?php if ($Page->user_id->Visible) { // user_id ?>
        <th data-name="user_id" class="<?= $Page->user_id->headerCellClass() ?>"><div id="elh_customers_user_id" class="customers_user_id"><?= $Page->renderFieldHeader($Page->user_id) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowCount ?>_customers__profile" class="el_customers__profile">
...
<span id="el<?= $Page->RowCount ?>_customers_state" class="el_customers_state">
...
<span id="el<?= $Page->RowCount ?>_customers_user_id" class="el_customers_user_id">
