...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fcustomersdelete = new ew.Form("fcustomersdelete", "delete");
    currentPageID = ew.PAGE_ID = "delete";
    currentForm = fcustomersdelete;
...
$Page->showMessage();
?>
<form name="fcustomersdelete" id="fcustomersdelete" class="ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->state->Visible) { // state ?>
        <th class="<?= $Page->state->headerCellClass() ?>"><span id="elh_customers_state" class="customers_state"><?= $Page->state->caption() ?></span></th>
<?php } ?>
<?php if ($Page->user_id->Visible) { // user_id ?>
        <th class="<?= $Page->user_id->headerCellClass() ?>"><span id="elh_customers_user_id" class="customers_user_id"><?= $Page->user_id->caption() ?></span></th>
<?php } ?>
    </tr>
    </thead>
    <tbody>
