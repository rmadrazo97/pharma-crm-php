...
loadjs.ready("fsales_order_detailadd", function() {
    fsales_order_detailadd.createAutoSuggest(Object.assign({"id":"x_product_id","forceSelect":false}, ew.vars.tables.sales_order_detail.fields.product_id.autoSuggestOptions));
});
</script>
