...
<script>
loadjs.ready("fsales_order_detailadd", function() {
    fsales_order_detailadd.createAutoSuggest(Object.assign({"id":"x_unit_price","forceSelect":true}, ew.vars.tables.sales_order_detail.fields.unit_price.autoSuggestOptions));
});
</script>
