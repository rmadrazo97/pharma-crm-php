...
// Page object
$SalesOrderDetailEdit = &$Page;
?>
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { sales_order_detail: currentTable } });
var currentForm, currentPageID;
var fsales_order_detailedit;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fsales_order_detailedit = new ew.Form("fsales_order_detailedit", "edit");
    currentPageID = ew.PAGE_ID = "edit";
    currentForm = fsales_order_detailedit;
    ...
    // Form_CustomValidate
    fsales_order_detailedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
$Page->showMessage();
?>
<form name="fsales_order_detailedit" id="fsales_order_detailedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->order_detail_id->Visible) { // order_detail_id ?>
    <div id="r_order_detail_id"<?= $Page->order_detail_id->rowAttributes() ?>>
        <label id="elh_sales_order_detail_order_detail_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->order_detail_id->caption() ?><?= $Page->order_detail_id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<input type="hidden" data-table="sales_order_detail" data-field="x_order_detail_id" data-hidden="1" name="x_order_detail_id" id="x_order_detail_id" value="<?= HtmlEncode($Page->order_detail_id->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
