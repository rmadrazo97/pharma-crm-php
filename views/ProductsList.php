...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fproductslist = new ew.Form("fproductslist", "list");
    currentPageID = ew.PAGE_ID = "list";
    currentForm = fproductslist;
...
<form name="fproductslist" id="fproductslist" class="ew-form ew-list-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<table id="tbl_productslist" class="table table-bordered table-hover table-sm ew-table"><!-- .ew-table -->
<thead>
...
<?php if ($Page->product_id->Visible) { // product_id ?>
        <th data-name="product_id" class="<?= $Page->product_id->headerCellClass() ?>"><div id="elh_products_product_id" class="products_product_id"><?= $Page->renderFieldHeader($Page->product_id) ?></div></th>
<?php } ?>
<?php if ($Page->price->Visible) { // price ?>
        <th data-name="price" class="<?= $Page->price->headerCellClass() ?>"><div id="elh_products_price" class="products_price"><?= $Page->renderFieldHeader($Page->price) ?></div></th>
<?php } ?>
<?php
