...
$sideMenu->addMenuItem(4, "mi_sales_order_detail", $MenuLanguage->MenuPhrase("4", "MenuText"), $MenuRelativePath . "SalesOrderDetailList?cmd=resetall", -1, "", IsLoggedIn() || AllowListMenu('{85AC1F7A-98A0-49C6-8015-B66CB252E443}sales_order_detail'), false, false, "", "", false);
