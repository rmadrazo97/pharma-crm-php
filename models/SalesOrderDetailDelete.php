 ...
 * Page class
 */
class SalesOrderDetailDelete extends SalesOrderDetail
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SalesOrderDetailDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("SalesOrderDetailList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("SalesOrderDetailList"); // Return to list
                return;
            }
        }
