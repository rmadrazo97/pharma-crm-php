...
/**
 * Table class for sales_order
 */
class SalesOrder extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'sales_order';
        $this->TableName = 'sales_order';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`sales_order`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`sales_order`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("SalesOrderList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "SalesOrderEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "SalesOrderAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("SalesOrderView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("SalesOrderView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "SalesOrderAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "SalesOrderAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        return $this->keyUrl("SalesOrderDelete", $this->getUrlParm());
    }
    ...
    public function keyUrl($url, $parm = "")
    {
        if ($this->order_id->CurrentValue !== null) {
            $url .= "/" . $this->encodeKeyValue($this->order_id->CurrentValue);
        } else {
