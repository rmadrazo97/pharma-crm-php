...
class ProductsView extends Products
{
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("product_id") ?? Route("product_id")) !== null) {
            $this->RecKey["product_id"] = $keyValue;
        }
