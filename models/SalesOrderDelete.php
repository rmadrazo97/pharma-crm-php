 ...
 * Page class
 */
class SalesOrderDelete extends SalesOrder
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SalesOrderDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("SalesOrderList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("SalesOrderList"); // Return to list
                return;
            }
        }
