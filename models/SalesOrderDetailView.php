 ...
 * Page class
 */
class SalesOrderDetailView extends SalesOrderDetail
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SalesOrderDetailView";
    ...
    public function run()
    {
        ...
        if (Get("order_detail_id") !== null) {
            if ($ExportFileName != "") {
                $ExportFileName .= "_";
            }
            $ExportFileName .= Get("order_detail_id");
        }
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("order_detail_id") ?? Route("order_detail_id")) !== null) {
                ...
                $returnUrl = "SalesOrderDetailList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "SalesOrderDetailList"; // No matching record, return to list
                        }
                    break;
            }
            ...
            $returnUrl = "SalesOrderDetailList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
